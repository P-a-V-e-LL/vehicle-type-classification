...
- Cars196 - размеченный набор данных из открытого доступа (https://minio.inventos.ru/minio/datasets/fit/car_and_lic/vehicle-type-classification-2/cars196.tar.gz).
- dataset3.11 - вручную собранный, размеченный набор данных (https://minio.inventos.ru/minio/datasets/fit/car_and_lic/vehicle-type-classification-2/dataset3.11.tar.gz).
