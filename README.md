...
- cars196 - размеченный набор данных из открытого доступа, с полным набором классов в выборках.
...
- model_own_new_split - facenet, обеченный на наборе данных dataset3.11_new_split.
- model_20211203_rmsprop - facenet, обученный на наборе данных dataset3.11.
- facenet_l2_bn - facenet, где  был добавлен слой l2 нормализации, обученный на dataset3.11_new_split (250 эпох).
- facenet_l2_no_bn - facenet, где  был добавлен слой l2 нормализации вместо последнего слоя BatchNormalization, обученный на dataset3.11_new_split (250 эпох).
