...
Целью проекта является исследование возможности создания нейронной сети с неограниченным классификатором, которая должна будет запоминать новые для себя классы авто по одному изображению и успешно классифицировать их в дальнейшем.
...
Вся train выборка.
![](./cluster_images/all_train.png)

Вся val выборка.
![](./cluster_images/all_val.png)
