'''
Извлечение эмбедингов из класса, запись в структуру (список или словарь). Сохранить эту структуру в .pickle файл.
Сделать 3 варианта сохранения:
                            1 изображение   |
                            n изображений   | из класса
                            все изображения |

Вывод минимального и максимально возможного n.
'''
