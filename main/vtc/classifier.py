...
def db_to_data():
    '''Выгружает данные из бд в словарь'''
    pass

class Classifier:

    def __init__(self, model_path: str,  min_distance: int, required_size=(160, 160)): # pickle_data_path: str,
    ...
    def get_predict(self, image):
        ...
        #output_data = get_predict(image, model)
        interpreter = tflite.Interpreter(model_path=self.model_path)
        interpreter.allocate_tensors()
